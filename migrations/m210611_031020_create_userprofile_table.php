   ...
   */
   public function safeUp()
   {
      $this->createTable('{{%userprofile}}', [
         ...
         'fk_t_blood_id' => $this->integer(),
         'fk_t_civilstatus_id' => $this->integer(),
         'fk_t_home_id' => $this->integer(),
         'fk_t_transport_id' => $this->integer(),
         'fk_t_smoker_id' => $this->integer(),
         'fk_t_drinker_id' => $this->integer(),
         'fk_t_gender_id' => $this->integer(),
         'fk_t_employee_id' => $this->integer(),
         'fk_address_id' => $this->integer(),
